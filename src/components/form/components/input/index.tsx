...
const MessageComponent = ({ children, type = 'error', labelOnTop, disabled, isFilled }: IMessageComponent) => (
  <MessageWrapper type={type} labelOnTop={labelOnTop} disabled={disabled} isFilled={isFilled}>
    {children}
  </MessageWrapper>
);
const InputFilledComponent = ({
  ...
  return (
    <>
      ...
      <FilledFormField error={error} labelOnTop={labelOnTop} disabled={disabled} isFilled={!!field.value}>
        {rightIcon && (
          <FilledIconWrapper error={error} labelOnTop={labelOnTop} disabled={disabled}>
        ...
        {leftIcon && (
          ...
          >
            <i
              className={
                type === 'password' ? leftIconClassName + ' cursor-pointer leftIcon' : leftIconClassName + ' leftIcon'
              }
            />
          </FilledIconWrapper>
        )}
      ...
      {!error && notice && (
        <MessageComponent labelOnTop={labelOnTop} type="notice" disabled={disabled} isFilled={!!field.value}>
          {notice}
        </MessageComponent>
      )}
  ...
  return (
    <>
      ...
      <OutlinedFormField error={error} labelOnTop={labelOnTop} disabled={disabled}>
        {rightIcon && (
          <OutlinedIconWrapper error={error} labelOnTop={labelOnTop} disabled={disabled}>
            <i className={rightIcon} />
          </OutlinedIconWrapper>
        )}
        <OutlinedInputWrapper
        ...
        />
        {leftIcon && (
          <OutlinedIconWrapper onClick={passwordClickHandler} error={error} labelOnTop={labelOnTop} disabled={disabled}>
            <i
              className={
                type === 'password' ? leftIconClassName + ' cursor-pointer leftIcon' : leftIconClassName + ' leftIcon'
              }
  ...
  return (
    <>
      <TinyFormField error={error} labelOnTop={labelOnTop} disabled={disabled}>
        {rightIcon && (
          <TinyIconWrapper error={error} labelOnTop={labelOnTop} disabled={disabled}>
            <i className={rightIcon} />
          </TinyIconWrapper>
        )}
      ...
      {!error && notice && (
        <MessageComponent labelOnTop={labelOnTop} type="notice" disabled={disabled}>
          {notice}
        </MessageComponent>
      )}
      <ErrorMessage name={field.name} component={MessageComponent} />
